...
// Build the question sets
const soc2TypeIQuestions = [
...
const soc2TypeIIQuestions = soc2TypeIQuestions; // Same criteria apply; distinction is design vs operating effectiveness

const soc2TypesBlock = `

// ===================================================================
// SOC 2 Type I vs Type II question sets
// - Type I:  "Do you HAVE the control designed and in place?" (point-in-time)
...
const SOC2_TYPE_I_QUESTIONS = ${JSON.stringify(soc2TypeIQuestions, null, 2)};

const SOC2_TYPE_II_QUESTIONS = ${JSON.stringify(soc2TypeIIQuestions, null, 2)};
...
const SOC2_TYPES: SOC2TypeInfo[] = [
  ...
  },
  {
    ...
    questions: SOC2_TYPE_II_QUESTIONS,
  },
];
`;

// Insert soc2Types into the Framework export and append the block at the end
content = content.replace(/^};\s*$/m, ",\n  soc2Types: SOC2_TYPES,\n};");
content = content.replace(/^export const soc2: Framework/m, "import { Framework, SOC2TypeInfo } from \"@/lib/types\";\n\nexport const soc2: Framework");

// Insert the import at the very top (after any leading comments)
content = content.replace(/(import .* from "@\/lib\/types";?)/, '$1\nimport type { SOC2TypeInfo } from "@/lib/types";');

// Append the question sets + SOC2_TYPES
const finalContent = content + soc2TypesBlock;

fs.writeFileSync(filePath, finalContent);
console.log("Added SOC 2 Type I/II question sets");
console.log("Type I/II questions:", soc2TypeIQuestions.length);
